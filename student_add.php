...
<div class="row">
        <div class="col-md-3 bg-info">
               <div align="center" class="btn-light text-dark pt-2 pl-3 pr-3 pb-2 m-1 rounded"><a href="index.php" ><i class="fa fa-home text-dark pr-1"> </i></a><span><b>- Student</b></span><a href="student_add.php" class="text-danger fw-bold"> - Add</a></div>
        </div>
...
<div class="form">
        ...
        <table>
                ...
                <tr>
                        ...
                        <td><input type="reset" class="btn pt-1 pl-3 pr-3 pb-1 btn-danger mt-4 mb-4" value="Reset"></td>
                </tr>
