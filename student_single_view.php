...
<div class="row">
        <div class="col-md-2 bg-info">
               <div align="center" class="btn-light text-dark pt-1 pl-2 pr-2 pb-1 m-1 rounded"><a href="index.php" ><i class="fa fa-home text-dark pr-1"> </i></a><span><b>- Student</b></span><a href="student_view.php" class="text-danger fw-bold"> - View</a></div>
        </div>
...
<div class="form">
        ...
        <table>
                ...
                <tr>
                        <td>Photo:</td>
                        <td><img class="m-2 p-1 img-thumbnail" src="<?php echo "include/student_image_and_document/".$row['photo']; ?>" alt="Photo" height="75" width="75" ></td>
                </tr>
                <tr>
                        <td>Document:</td>
                        <td><img src="<?php echo "include/student_image_and_document/".$row['document_image']; ?>" alt="Document" class="m-2 p-1 img-thumbnail" height="75" width="75" ></td>
                </tr>
                <tr>
                ...
                <tr>
                        <td><a href="student_view.php" class="btn btn-info px-3 mb-5 py-1 text-center">Back </a></td>
                </tr>
